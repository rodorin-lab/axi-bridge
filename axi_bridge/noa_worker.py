...
def append_party_bus_message(payload: dict) -> None:
    with open(PARTY_BUS_PATH, "a", encoding="utf-8") as handle:
        handle.write(json.dumps(payload, ensure_ascii=False) + "\n")


def append_thinking_status() -> None:
    payload = {
        "speaker": "noa",
        "text": "thinking...",
        "type": "status",
    ...
    append_party_bus_message(payload)
